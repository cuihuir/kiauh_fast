...
#  ======================================================================= #
"""Manual Installation Menu - Original KIAUH menu logic"""
...
class ManualInstallMenu(BaseMenu):
    """手工安装菜单 - 保持原有 KIAUH 逻辑"""

    def __init__(self, previous_menu: Type[BaseMenu] | None = None) -> None:
        super().__init__()

        self.header: bool = True
        self.title = "Manual Installation / 手工安装"
        self.title_color = Color.CYAN
        self.footer_type: FooterType = FooterType.BACK
